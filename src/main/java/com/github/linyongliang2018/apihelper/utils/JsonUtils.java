...
import com.github.linyongliang2018.apihelper.jsonSchema.KV;
...
import static com.github.linyongliang2018.apihelper.jsonSchema.BuildJsonForYapi.getFields;
...
public class JsonUtils {
    ...
    public static String getPojoJson(Project project, PsiType psiType) {
        ...
        if (types.length > 1) {
            ...
            LinkedHashMap<String, Object> kvObject = getFields(psiClassChild, project, types, 1, requiredList);
            ...
            // 获取子类的字段，并将它们添加到kvObject中
            LinkedHashMap<String, Object> kvObject = getFields(psiClassChild, project, null, null, requiredList);
